  ...
  return (
    <div className="space-y-12 py-4">
      ...
      <section className="grid gap-6 lg:grid-cols-[0.8fr_1.2fr]">
        <article className="rounded-3xl border border-border bg-[linear-gradient(135deg,rgba(15,118,110,0.12),rgba(255,250,242,0.92))] p-6 shadow-sm">
        ...
        <article className="rounded-3xl border border-border bg-white/80 p-6 shadow-sm">
          <h3 className="text-xl font-semibold">Catatan Verifikasi Data</h3>
          <p className="mt-4 text-sm leading-7 text-muted">
